 ...
 * MakonTV API Server
 *
 * Hono — ultra-fast, serverless-ready, Vercel-compatible.
 * All routes auto-localize via ?lang=ru|uz query parameter.
 */
...
app.use('/*', logger());
app.use('/*', cors({
  origin: ['http://localhost:3000', 'http://localhost:5173', 'https://*.vercel.app', 'https://*.netlify.app'],
...
// ═══ API DOCS (краткий список endpoints) ═══
